...
export function Header({ isAdmin = false }: HeaderProps) {
  ...
  return (
    ...
    >
      ...
      <div className="border-b border-amber-200/80 bg-amber-50 text-slate-800">
        <p className="mx-auto max-w-7xl px-4 py-1.5 text-center text-[0.7rem] font-semibold leading-4 sm:px-5 lg:px-8 lg:text-xs">
