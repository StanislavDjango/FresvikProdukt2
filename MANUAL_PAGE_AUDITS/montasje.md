# Manual page migration audit: /tenester/montasje

Source URL: https://www.fresvik.no/tenester/montasje
Checked: 2026-06-13
Local route: /tenester/montasje
Status: migrated

## Rule

This service page was migrated manually because the earlier local version contained a shortened summary and TODO notes instead of the visible donor-page structure. The page is treated as migrated for visible donor content, service links, images, PDF links, footer contact blocks and certification/external links. Generic Squarespace mechanics such as cart count and menu toggle text are not counted as page content.

## Section coverage

| Old section | New section | Text | Images | Links | Status |
| --- | --- | --- | --- | --- | --- |
| Service intro | Fresvik produkt tilbyr montasje av | Old intro label copied | `_K6R3776_07032013.jpg`, `flake-black.png`, `flake.png` | product/service routes preserved | migrated |
| Montage service list | Fresvik produkt tilbyr montasje av | Product/service labels copied, including `Kjøle- og fryseportar`, `Kjøle- og frysedører`, `Vindu`, `Beslag` | old montage and snowflake images | product routes preserved | migrated |
| Sentral godkjenning | Sentral godkjenning | Full visible text about competence, experience, quality routines and taxes copied | certification badge available in certification block | local PDF link preserved | migrated |
| More information | Meir informasjon om montasje? | Old sales contact CTA copied | none | contact mail links in next section | migrated |
...
| --- | --- | --- |
| `/assets/fresvik/images/old-site/_K6R3776_07032013.jpg` | `https://images.squarespace-cdn.com/content/v1/64ec79dc5754e2533112d764/1693228769500-4TTIXKAO1JNS9J2G51MG/_K6R3776_07032013.jpg` | montage/service image |
...
| `/assets/fresvik/images/old-site/flake.png` | `https://images.squarespace-cdn.com/content/v1/64ec79dc5754e2533112d764/13922f08-1a26-4996-98ca-874c87c1d3cb/flake.png` | old service/product placeholder image |
...
- `npm run migration:crawl-page -- https://www.fresvik.no/tenester/montasje`
- `npm run migration:compare-page -- https://www.fresvik.no/tenester/montasje /tenester/montasje --new-base http://127.0.0.1:3060 --allow-partial`
- Result: `migrated`, missing text/images/links = `0/0/0`.

## Notes

- `/tenester/montasje` was added to `localMigrationStructurePaths` so the exact local migration is not overwritten by the current Sanity service fallback.
